<div style="margin-top: 14px; background-color: white;padding: 30px">
	...
	<form action="<?php echo base_url('index.php/admin/setting/update') ?>" method="post" enctype="multipart/form-data">
		<div class="media">
			<img id="preview" class="align-self-center mr-3 rounded-circle border border-info" src="<?php echo base_url('assets/img/lembaga/'.$infopt->logo_pt) ?>" width="50px" alt="Generic placeholder image">
		...
		<h5 class="text-info">Informasi Dasar</h5><hr/>
		<div class="row">
			<div class="col">
		...
		<h5 class="text-info">Informasi Pendaftaran</h5><hr/>
		<div class="row">
			<div class="col">
				<div class="form-group">
					<label for="angkatan">Angkatan</label>
					<input type="text" class="form-control" name="angkatan" id="angkatan" aria-describedby="angkatan" placeholder="Angkatan Peserta/ Tahun Saat Ini" value="<?php echo $infopt->angkatan ?>">
					<small id="angkatan" class="form-text text-muted">hanya boleh menggunakan angka</small>
				</div>
			</div>
			<div class="col">
				<div class="form-group">
					<label for="alias_angkatan">Alias Angkatan</label>
					<input type="text" class="form-control" name="alias_angkatan" id="alias_angkatan" aria-describedby="alias_angkatan" placeholder="Angkatan Peserta/ Tahun Saat Ini" value="<?php echo $infopt->alias_angkatan ?>">
					<small id="alias_angkatan" class="form-text text-muted">hanya boleh menggunakan angka</small>
				</div>
			</div>
			<div class="col">
				<div class="form-group">
					<label for="tahun">Tahun</label>
					<input type="text" class="form-control" name="tahun" id="tahun" aria-describedby="tahun" placeholder="2 digit terakhir tahun, Misal 2018 di tulis 18" value="<?php echo $infopt->tahun ?>">
					<small id="tahun" class="form-text text-muted">hanya boleh menggunakan angka</small>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="gelombang" id="gelombang" aria-describedby="gelombang" placeholder="Gelombang pendaftaran" value="<?php echo $infopt->gelombang ?>">
					<small id="gelombang" class="form-text text-muted">hanya boleh menggunakan angka</small>
				</div>
			</div>
			<div class="col">
				<div class="form-group">
					<label for="biaya">Biaya Pendaftaran</label>
					<input type="text" class="form-control" name="biaya" id="biaya" aria-describedby="biaya" placeholder="Biaya Pendaftaran Peserta" value="<?php echo $infopt->biaya ?>">
					<small id="biaya" class="form-text text-muted">hanya boleh menggunakan angka</small>
				</div>
			</div>
		</div>
