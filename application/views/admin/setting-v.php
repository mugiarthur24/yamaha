...
<div class="card">
	<div class="card-header">
		<b>Setting Dasar Perusahaan</b>
		<span class="text-muted">Pengaturan dan data dasar perusahaan</span>
	</div>
	<div class="card-body">
		<form action="<?php echo base_url('index.php/admin/setting/update/'.$infopt->id_info_pt) ?>" method="post" enctype="multipart/form-data">
			<div class="media">
			...
			<div class="row">
				...
				<div class="col">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="kode_pt" id="kode_pt" aria-describedby="kode_pt" placeholder="Daerah Perusahaan" value="<?php echo $infopt->kode_pt ?>">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="slogan" id="slogan" aria-describedby="slogan" placeholder="Slogan Perusahaan" value="<?php echo $infopt->slogan ?>">
