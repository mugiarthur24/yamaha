                                ...
                                <li class="pcoded-hasmenu ">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="pcoded-hasmenu ">
                                            ...
                                            <ul class="pcoded-submenu">
                                                <li class="">
                                                    <a href="<?php echo base_url('assets/adminty/files/') ?>\extra-pages\email-templates\email-welcome.htm">
                                                        <span class="pcoded-mtext">Welcome Email</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="<?php echo base_url('assets/adminty/files/') ?>\extra-pages\email-templates\email-password.htm">
                                                        <span class="pcoded-mtext">Reset Password</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="<?php echo base_url('assets/adminty/files/') ?>\extra-pages\email-templates\email-newsletter.htm">
                                                        <span class="pcoded-mtext">Newsletter Email</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="<?php echo base_url('assets/adminty/files/') ?>\extra-pages\email-templates\email-launch.htm">
                                                        <span class="pcoded-mtext">App Launch</span>
                                                    </a>
                                                </li>
                                                <li class="">
                                                    <a href="<?php echo base_url('assets/adminty/files/') ?>\extra-pages\email-templates\email-activation.htm">
